...
from model_search import NetworkImageNet
...
def parse_args():
    ...
    parser.add_argument('--min_warmup', type=int, default=10, help='minimum warmup epoch')
...
def main(args):
    ...
    model = NetworkImageNet(args.init_channels, args.num_classes, args.layers, args.net_mode, args.data_mode, args.prune_direct, args.affine, args.skip_r_num, args.pool_r_num).cuda()
    ...
    arch_optimizer = torch.optim.Adam(model.module.alpha_params(), lr=args.arch_lr, weight_decay=args.arch_weight_decay, betas=(args.arch_adam_beta1, args.arch_adam_beta2))
